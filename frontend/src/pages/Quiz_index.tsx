...
export const Quiz = () => {
  ...
  const submitQuiz = async () => {
    ...
    try {
      ...
      console.log("Iniciando grava├º├úo de perfil...", payload);
      
      // Salva a ├║ltima resposta (Calorias di├írias) como completo
      ...
      console.log("Perfil salvo! Atualizando usu├írio no contexto local...");
      await trackingService.logEvent('quiz_completed', payload);
      await refreshUser(); // Garante que a sess├úo local reconhe├ºa que o onboarding acabou
  ...
  const stepMeta = [
    { id: 1, title: 'INFORMA├ç├òES PESSOAIS', question: 'Qual a sua idade?', helper: 'Isso ajuda a calcular suas necessidades di├írias.', icon: Calendar },
    { id: 2, title: 'IDENTIDADE', question: 'Qual ├⌐ o seu g├¬nero?', helper: 'As f├│rmulas metab├│licas diferem ligeiramente.', icon: User },
    { id: 3, title: 'M├ëTRICAS CORPORAIS', question: 'Qual a sua altura?', helper: 'Necess├írio para calcular sua Taxa Metab├│lica.', icon: Ruler },
    { id: 4, title: 'M├ëTRICAS CORPORAIS', question: 'Peso atual?', helper: 'Este ├⌐ o seu ponto de partida.', icon: Scale },
    { id: 5, title: 'SEU OBJETIVO', question: 'Qual ├⌐ a sua meta?', helper: 'Ajustaremos as calorias para corresponder ao objetivo.', icon: Target },
    { id: 6, title: 'ESTILO DE VIDA', question: 'Qu├úo ativo voc├¬ ├⌐?', helper: 'Isso determina seu gasto energ├⌐tico di├írio.', icon: Activity },
    { id: 7, title: 'SEU OBJETIVO', question: 'Peso alvo?', helper: 'Estabele├ºa uma meta realista e saud├ível.', icon: Target },
    { id: 8, title: 'META NUTRICIONAL', question: 'Quantas calorias voc├¬ deseja consumir por dia?', helper: 'Escolha sua meta di├íria de calorias para acompanhar sua alimenta├º├úo.', icon: Target },
  ];
      ...
      case 6:
        return (
          <div className="space-y-2.5 mt-4">
            {renderSelectableCard('activity_level', 'Sedent├írio', null, 'Pouco/nenhum exerc├¡cio')}
            {renderSelectableCard('activity_level', 'Levemente ativo', null, 'Exerc├¡cio leve 1-3 dias/sem')}
            {renderSelectableCard('activity_level', 'Moderadamente ativo', null, 'Exerc├¡cio 3-5 dias/sem')}
            {renderSelectableCard('activity_level', 'Muito ativo', null, 'Exerc├¡cio intenso 6-7 dias/sem')}
          </div>
        );
      case 7:
