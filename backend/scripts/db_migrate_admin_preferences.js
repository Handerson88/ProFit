...
async function migrate() {
    console.log('Starting Admin Preferences migration...');
    try {
        // Create Table
        await db.query(`
        ...
        `);
        console.log('Table admin_preferences verified/created.');
        ...
        await db.query(`
            DROP TRIGGER IF EXISTS trigger_update_admin_preferences_timestamp ON admin_preferences;
            CREATE TRIGGER trigger_update_admin_preferences_timestamp
